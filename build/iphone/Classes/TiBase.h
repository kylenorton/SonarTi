...
// in simulator we redefine to format for SONARTi Developer console
...
{\
	NSString * exceptionName = [@"org.sonarti." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.sonarti";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UISONARTiNativeItemNone = -1, 
	UISONARTiNativeItemSpinner = -2,
	UISONARTiNativeItemProgressBar = -3,
	
	UISONARTiNativeItemSlider = -4,
	UISONARTiNativeItemSwitch = -5,
	UISONARTiNativeItemMultiButton = -6,
	UISONARTiNativeItemSegmented = -7,
	
	UISONARTiNativeItemTextView = -8,
	UISONARTiNativeItemTextField = -9,
	UISONARTiNativeItemSearchBar = -10,
	
	UISONARTiNativeItemPicker = -11,
	UISONARTiNativeItemDatePicker = -12,
	
	UISONARTiNativeItemInfoLight = -13,
	UISONARTiNativeItemInfoDark = -14,
	
	UISONARTiNativeItemDisclosure = -15,
	
	UISONARTiNativeItemContactAdd = -16
};
