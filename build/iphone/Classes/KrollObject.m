 ...
 * Copyright (c) 2009-2011 by SONARTi, Inc. All Rights Reserved.
...
//@interface SONARTiObject : NSObject
//@end

@interface SONARTiObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[SONARTiObject class]])
		{
			for (NSString *key in [[(SONARTiObject*)o modules] allKeys])
			{
